document.addEventListener("DOMContentLoaded", () => {
  /* --- MATRIX CANVAS EFFECT (Interactive with Enhanced Mouse Response) --- */
  ...
  const keywords = {
    greeting: ["cześć", "czesc", "hej", "witaj", "siema", "hello", "hi", "dzień dobry", "dzien dobry", "elo", "joł", "yo", "hejka", "siemka", "cześć!", "halo"],
    farewell: ["pa", "papa", "do widzenia", "narazie", "nara", "bye", "goodbye", "do zobaczenia", "żegnaj", "trzymaj się"],
    services: ["usługi", "uslugi", "oferta", "co robisz", "czym się zajmujesz", "co oferujesz", "jakie usługi", "w czym pomagasz"],
    landing: ["landing page", "landing", "landingpage", "strona lądowania", "one page", "onepage", "jednostronicowa"],
    businessCard: ["wizytówka", "wizytowka", "strona firmowa", "strona firmy", "firmowa strona", "business card", "strona wizytówka"],
    ecommerce: ["sklep", "e-commerce", "ecommerce", "woocommerce", "sprzedaż online", "sklep internetowy", "shop", "sprzedawać"],
    price: ["cena", "koszt", "ile kosztuje", "wycena", "budżet", "budzet", "cennik", "ile płacę", "ile zapłacę", "pricing", "kasa", "pieniądze", "za ile"],
    contact: ["kontakt", "email", "mail", "telefon", "napisać", "napisac", "skontaktować", "gdzie cię znajdę", "jak się kontaktować", "numer"],
    time: ["czas", "jak długo", "jak dlugo", "kiedy", "termin", "realizacja", "ile trwa", "deadline", "do kiedy", "jak szybko"],
    wordpress: ["wordpress", "wp", "cms", "woocommerce", "wtyczki", "plugins", "theme", "motyw"],
    about: ["o tobie", "kim jesteś", "kim jestes", "domindev", "domin dev", "twórca", "developer", "programista", "wrocław", "wroclaw", "kto ty"],
    process: ["jak pracujesz", "proces", "etapy", "jak wygląda", "jak wyglada", "współpraca", "wspolpraca", "jak to działa"],
    portfolio: ["portfolio", "realizacje", "projekty", "przykłady", "przyklady", "co robiłeś", "co robiles", "case study", "prace"],
    tech: ["technologie", "tech stack", "narzędzia", "narzedzia", "czego używasz", "javascript", "react", "php", "html", "css", "acf"],
    seo: ["seo", "pozycjonowanie", "google", "optymalizacja", "widoczność", "wyszukiwarka", "ranking"],
    security: ["bezpieczeństwo", "bezpieczenstwo", "security", "ssl", "https", "ochrona", "backup", "bezpieczna"],
    hosting: ["hosting", "domena", "serwer", "gdzie hostować", "przeniesienie strony", "migracja"],
    support: ["wsparcie", "pomoc", "po wdrożeniu", "szkolenie", "nauka", "obsługa", "jak zarządzać"],
    thanks: ["dziękuję", "dziekuje", "dzięki", "dzieki", "thanks", "thx", "dzięks", "super", "świetnie", "ok"],
    positive: ["fajnie", "cool", "nice", "spoko", "okej", "dobra", "git", "extra", "bomba", "zajebiste", "super!"],
    robot: ["bot", "robot", "ai", "sztuczna inteligencja", "automat", "czy jesteś człowiekiem", "czy jestes czlowiekiem", "człowiek czy bot"],
    joke: ["żart", "zart", "dowcip", "kawał", "kawal", "pośmiej się", "joke", "śmieszne", "smieszne", "haha", "lol"],
    competition: ["konkurencja", "inni", "dlaczego ty", "czemu ty", "lepszy", "porównanie"],
    discount: ["zniżka", "znizka", "rabat", "promocja", "taniej", "discount", "promo"],
    blog: ["blog", "blogowanie", "artykuły", "artykuly", "wpisy", "publikacje", "content marketing"],
    socialMedia: ["social media", "facebook", "instagram", "linkedin", "twitter", "tiktok", "media społecznościowe", "social"],
    form: ["formularz", "formularz kontaktowy", "kontakt formularz", "forma kontaktu", "jak się skontaktować przez stronę"],
    redesign: ["redesign", "przebudowa", "odświeżenie", "odswiezenie", "modernizacja", "nowy wygląd", "zmiana wyglądu", "stara strona"],
    maintenance: ["utrzymanie", "opieka", "maintenance", "aktualizacje", "serwis strony", "opieka nad stroną"],
    multilang: ["wielojęzyczna", "wielojezyczna", "język", "jezyk", "angielska wersja", "tłumaczenie", "tlumaczenie", "inne języki", "po angielsku"],
    analytics: ["analytics", "analityka", "statystyki", "google analytics", "ga4", "tracking", "śledzenie"],
    speed: ["szybkość", "szybkosc", "wolna strona", "ładowanie", "ladowanie", "page speed", "wydajność", "wydajnosc", "optymalizacja"],
    accessibility: ["dostępność", "dostepnosc", "wcag", "a11y", "niepełnosprawni", "czytnik ekranu", "accessibility"],
    graphics: ["grafika", "zdjęcia", "zdjecia", "obrazki", "foto", "ilustracje", "ikony", "stocki"],
    copywriting: ["copywriting", "teksty", "treści", "tresci", "pisanie tekstów", "copy"],
    startup: ["startup", "nowy biznes", "nowa firma", "zaczynam", "początek", "poczatek", "pierwszy projekt"],
    local: ["lokalna", "lokalny", "moje miasto", "okolica", "w mojej miejscowości", "google moja firma", "gmf"],
    corporate: ["korporacja", "korporacyjna", "duża firma", "enterprise", "rozbudowana strona"],
    booking: ["rezerwacje", "rezerwacja", "booking", "kalendarz", "umawianie", "wizyty", "terminy"],
    membership: ["członkostwo", "czlonkostwo", "subskrypcja", "premium", "logowanie", "rejestracja", "strefa klienta", "konto użytkownika"],
    payments: ["płatności", "platnosci", "payu", "przelewy24", "stripe", "blik", "płacenie online", "bramka płatności"],
    invoices: ["faktury", "fakturowanie", "księgowość", "ksiegowosc", "fakturownia", "ifirma", "jpk"],
    newsletter: ["newsletter", "mailing", "mailchimp", "mailerlite", "email marketing", "zapis do newslettera"],
    problems: ["problem", "nie działa", "nie dziala", "błąd", "blad", "zhakowana", "hack", "zepsuta", "wolna", "spadła pozycja"],
    migration: ["migracja", "przeniesienie", "przenieść", "przeniesc", "zmiana hostingu", "zmiana domeny", "z wix", "z squarespace"],
    freeVsPaid: ["wix", "squarespace", "kreator stron", "darmowa strona", "za darmo", "samemu zrobić"]
  };

  // Wulgarne słowa (podstawowe - filtr)
  const vulgarWords = [
    "kurwa", "kurwy", "kurwą", "chuj", "chuja", "chujem", "chuje",
    "pierdol", "pierdole", "pierdoli", "pierdolę", "pierdolony",
    "jebać", "jebac", "jebany", "jebana", "jebie", "jebię",
    "skurwysyn", "skurwiel", "szmata", "dziwka", "suka",
    "dupa", "dupą", "dupie", "gówno", "gowno", "srać", "srac",
    "fuck", "shit", "bitch", "asshole", "dick", "pussy",
    "cholera", "psiakrew", "kurde", "kurna", "do diabła",
    "idiota", "debil", "kretyn", "głupek", "glupek", "dureń", "duren"
  ];
  ...
  const glossary = {
    // --- STRONY WWW ---
    "landing page": "📄 <strong>Landing Page</strong> - jednostronicowa strona nastawiona na jeden cel (np. sprzedaż, zapis na newsletter). Bez menu, maksymalnie prosta, zoptymalizowana pod konwersję.",
    "strona wizytówka": "🏢 <strong>Strona Wizytówka</strong> - wielostronicowa strona firmowa prezentująca firmę, usługi i dane kontaktowe. Fundament obecności online każdej firmy.",
    "one page": "📄 <strong>One Page</strong> - to samo co Landing Page. Cała treść na jednej, przewijanej stronie bez podstron.",
    "strona responsywna": "📱 <strong>Responsywność</strong> - strona automatycznie dostosowuje się do ekranu urządzenia (komputer, tablet, telefon). Dziś to standard.",
    "strona statyczna": "📁 <strong>Strona statyczna</strong> - strona bez bazy danych, czyste pliki HTML/CSS/JS. Szybka, bezpieczna, ale trudniejsza w edycji bez wiedzy technicznej.",
    "strona dynamiczna": "⚙️ <strong>Strona dynamiczna</strong> - strona z bazą danych i CMS. Treść można edytować przez panel administracyjny bez znajomości kodu.",
    ...
    "wordpress": "🔵 <strong>WordPress</strong> - najpopularniejszy CMS na świecie (~43% stron). Darmowy, elastyczny, z tysiącami wtyczek i motywów.",
    "woocommerce": "🛒 <strong>WooCommerce</strong> - darmowa wtyczka do WordPressa zamieniająca stronę w sklep internetowy. Obsługuje płatności, dostawy, magazyn.",
    "theme": "🎨 <strong>Theme (motyw)</strong> - szablon graficzny strony WordPress. Definiuje wygląd, układ i podstawowe funkcje.",
    "plugin": "🔌 <strong>Plugin (wtyczka)</strong> - dodatek rozszerzający funkcjonalność strony. Np. formularz kontaktowy, SEO, galeria zdjęć.",
    "wtyczka": "🔌 <strong>Wtyczka</strong> - to samo co plugin. Dodatek do CMS rozszerzający jego możliwości.",
    ...
    "frontend": "🖥️ <strong>Frontend</strong> - warstwa wizualna strony, którą widzi użytkownik. HTML, CSS, JavaScript.",
    "backend": "⚙️ <strong>Backend</strong> - warstwa serwerowa strony, niewidoczna dla użytkownika. Logika, baza danych, przetwarzanie.",
    "fullstack": "👨‍💻 <strong>Fullstack</strong> - developer znający zarówno frontend jak i backend. Może zbudować całą aplikację od A do Z.",
    ...
    "pozycjonowanie": "📈 <strong>Pozycjonowanie</strong> - to samo co SEO. Działania mające na celu poprawę widoczności strony w wynikach wyszukiwania.",
    "konwersja": "🎯 <strong>Konwersja</strong> - wykonanie przez użytkownika pożądanej akcji (zakup, zapis, kontakt). Wskaźnik skuteczności strony.",
    "cta": "🔘 <strong>CTA</strong> (Call To Action) - przycisk lub link zachęcający do działania. Np. 'Kup teraz', 'Zapisz się', 'Skontaktuj się'.",
    "call to action": "🔘 <strong>Call To Action</strong> - element strony zachęcający użytkownika do podjęcia konkretnej akcji (kliknięcia, zakupu, kontaktu).",
    ...
    "bounce rate": "📉 <strong>Bounce Rate</strong> - współczynnik odrzuceń. Procent osób, które opuściły stronę bez interakcji. Im niższy, tym lepiej.",
    "core web vitals": "📊 <strong>Core Web Vitals</strong> - metryki Google mierzące szybkość i użyteczność strony. Wpływają na pozycję w wyszukiwarce.",

    // --- HOSTING I DOMENY ---
    "hosting": "🖥️ <strong>Hosting</strong> - usługa przechowywania plików strony na serwerze, dzięki czemu jest dostępna online 24/7.",
    "domena": "🌐 <strong>Domena</strong> - adres strony w internecie (np. domindev.pl). Unikalny identyfikator Twojej witryny.",
    ...
    "https": "🔐 <strong>HTTPS</strong> - bezpieczny protokół komunikacji (z certyfikatem SSL). Kłódka w pasku adresu. Standard od 2018 roku.",
    ...
    // --- E-COMMERCE ---
    "e-commerce": "🛍️ <strong>E-commerce</strong> - handel elektroniczny. Sprzedaż produktów lub usług przez internet.",
    "koszyk": "🛒 <strong>Koszyk</strong> - miejsce gromadzenia produktów przed zakupem w sklepie internetowym.",
    "checkout": "💳 <strong>Checkout</strong> - proces finalizacji zamówienia: dane, dostawa, płatność, potwierdzenie.",
    "bramka płatności": "💰 <strong>Bramka płatności</strong> - system obsługujący płatności online (np. PayU, Przelewy24, Stripe, BLIK).",
    "dropshipping": "📦 <strong>Dropshipping</strong> - model sprzedaży bez własnego magazynu. Dostawca wysyła produkt bezpośrednio do klienta.",

    // --- BEZPIECZEŃSTWO ---
    "backup": "💾 <strong>Backup</strong> - kopia zapasowa strony. Niezbędna do odtworzenia w razie awarii lub ataku.",
    "firewall": "🛡️ <strong>Firewall</strong> - zapora sieciowa chroniąca przed nieautoryzowanym dostępem i atakami.",
    "malware": "🦠 <strong>Malware</strong> - złośliwe oprogramowanie. Wirusy, trojany mogące zainfekować stronę.",
    "ddos": "⚠️ <strong>DDoS</strong> - atak polegający na przeciążeniu serwera tysiącami zapytań, co powoduje niedostępność strony.",

    // --- INNE PRZYDATNE ---
    "briefing": "📋 <strong>Briefing</strong> - spotkanie/dokument określający cele, wymagania i oczekiwania wobec projektu.",
    "mockup": "🖼️ <strong>Mockup</strong> - wizualizacja projektu strony przed kodowaniem. Pokazuje jak będzie wyglądać efekt końcowy.",
    "wireframe": "📐 <strong>Wireframe</strong> - szkielet strony bez grafiki. Pokazuje rozmieszczenie elementów i strukturę.",
    "responsywność": "📱 <strong>Responsywność</strong> - zdolność strony do automatycznego dostosowania się do rozmiaru ekranu.",
    "mobile first": "📲 <strong>Mobile First</strong> - podejście projektowe: najpierw projektujemy wersję mobilną, potem desktopową.",
    "favicon": "⭐ <strong>Favicon</strong> - mała ikona strony wyświetlana na karcie przeglądarki i w zakładkach.",
    "above the fold": "👆 <strong>Above The Fold</strong> - część strony widoczna bez przewijania. Najważniejsza przestrzeń reklamowa.",
    "lazy loading": "⏳ <strong>Lazy Loading</strong> - technika ładowania obrazów dopiero gdy są potrzebne. Przyspiesza start strony.",
    "cache": "💨 <strong>Cache</strong> - pamięć podręczna przechowująca dane do szybszego ponownego załadowania strony.",
    "minifikacja": "📦 <strong>Minifikacja</strong> - kompresja kodu (usunięcie spacji, komentarzy) dla szybszego ładowania.",

    // --- NOWE: DESIGN & UX ---
    "hero section": "🦸 <strong>Hero Section</strong> - główna sekcja na górze strony z nagłówkiem, hasłem i CTA. Pierwsze co widzi użytkownik.",
    "header": "📌 <strong>Header</strong> - nagłówek strony z logo i menu nawigacyjnym. Zazwyczaj przyklejony na górze.",
    "footer": "📍 <strong>Footer</strong> - stopka strony z kontaktem, linkami i informacjami prawnymi. Na samym dole.",
    "sidebar": "📐 <strong>Sidebar</strong> - boczny panel strony, często z menu, widgetami lub reklamami.",
    "breadcrumbs": "🍞 <strong>Breadcrumbs</strong> - ścieżka nawigacji pokazująca gdzie jesteś na stronie (np. Strona główna > Blog > Artykuł).",
    "hamburger menu": "☰ <strong>Hamburger Menu</strong> - ikona trzech kresek ukrywająca menu na urządzeniach mobilnych.",
    "modal": "🪟 <strong>Modal</strong> - wyskakujące okienko nakładane na stronę (popup). Używane do formularzy, alertów.",
    "slider": "🎠 <strong>Slider</strong> - karuzela zdjęć lub treści przesuwająca się automatycznie lub manualnie.",
    "accordion": "🪗 <strong>Accordion</strong> - rozwijane sekcje FAQ. Kliknięcie rozwija odpowiedź, oszczędza miejsce.",
    "tooltip": "💬 <strong>Tooltip</strong> - dymek z podpowiedzią pojawiający się po najechaniu na element.",
    "placeholder": "📝 <strong>Placeholder</strong> - tekst zastępczy w polu formularza znikający po kliknięciu.",
    "grid": "🔲 <strong>Grid</strong> - układ siatki do rozmieszczania elementów na stronie. CSS Grid to standard.",
    "flexbox": "📏 <strong>Flexbox</strong> - system układu CSS do elastycznego pozycjonowania elementów w rzędach/kolumnach.",
    ...
    "javascript": "⚡ <strong>JavaScript</strong> - język programowania dodający interaktywność stronie. Animacje, formularze, dynamika.",
    "php": "🐘 <strong>PHP</strong> - język backendowy używany przez WordPress. Przetwarza dane i generuje strony.",
    "mysql": "🗄️ <strong>MySQL</strong> - baza danych przechowująca treści strony. WordPress używa MySQL.",
    "json": "📋 <strong>JSON</strong> - format wymiany danych. Lekki, czytelny dla ludzi i maszyn.",
    "rest api": "🔌 <strong>REST API</strong> - interfejs do komunikacji między systemami przez HTTP. WordPress ma wbudowane.",
    "git": "🌿 <strong>Git</strong> - system kontroli wersji. Śledzi zmiany w kodzie, umożliwia cofanie i współpracę.",
    "github": "🐙 <strong>GitHub</strong> - platforma do hostowania kodu i współpracy developerów. Portfolio programisty.",
    "npm": "📦 <strong>NPM</strong> - menedżer pakietów JavaScript. Instaluje biblioteki i narzędzia.",
    "webpack": "📦 <strong>Webpack</strong> - bundler łączący pliki JS/CSS w zoptymalizowane paczki.",
    "sass": "💅 <strong>SASS/SCSS</strong> - preprocesor CSS dodający zmienne, zagnieżdżenia i funkcje.",
    "bootstrap": "🅱️ <strong>Bootstrap</strong> - framework CSS z gotowymi komponentami. Przyspiesza tworzenie stron.",
    "tailwind": "🌊 <strong>Tailwind CSS</strong> - framework utility-first. Style przez klasy w HTML.",
    "react": "⚛️ <strong>React</strong> - biblioteka JavaScript do budowania interfejsów. Komponenty i Virtual DOM.",
    "vue": "💚 <strong>Vue.js</strong> - framework JavaScript do tworzenia aplikacji. Reaktywny i łatwy w nauce.",
    "node.js": "💚 <strong>Node.js</strong> - środowisko uruchomieniowe JavaScript po stronie serwera.",

    // --- NOWE: WORDPRESS SZCZEGÓŁY ---
    "gutenberg": "📝 <strong>Gutenberg</strong> - edytor blokowy WordPressa. Tworzenie treści przez przeciąganie bloków.",
    "elementor": "🔧 <strong>Elementor</strong> - popularny page builder WordPress. Drag & drop bez kodowania.",
    "divi": "🎨 <strong>Divi</strong> - motyw i builder WordPress. Wizualny edytor z wieloma modułami.",
    "child theme": "👶 <strong>Child Theme</strong> - motyw potomny dziedziczący po głównym. Bezpieczne modyfikacje.",
    "custom post type": "📑 <strong>Custom Post Type</strong> - własny typ treści w WP (np. Portfolio, Produkty, Referencje).",
    "taxonomy": "🏷️ <strong>Taxonomy</strong> - system kategoryzacji w WP. Kategorie i tagi to wbudowane taksonomie.",
    "shortcode": "⚡ <strong>Shortcode</strong> - krótki kod w nawiasach [] wstawiający dynamiczną treść w WordPress.",
    "hook": "🪝 <strong>Hook</strong> - punkt zaczepienia w WP pozwalający modyfikować działanie bez zmiany kodu źródłowego.",
    "wp-admin": "🔐 <strong>WP-Admin</strong> - panel administracyjny WordPressa. Dostęp przez /wp-admin.",
    "wp-config": "⚙️ <strong>wp-config.php</strong> - plik konfiguracyjny WP z danymi bazy, kluczami bezpieczeństwa.",

    // --- NOWE: SEO ZAAWANSOWANE ---
    "serp": "📊 <strong>SERP</strong> - strona wyników wyszukiwania Google. Pozycja w SERP = widoczność.",
    "meta title": "📰 <strong>Meta Title</strong> - tytuł strony widoczny w wynikach Google i na karcie przeglądarki.",
    "meta description": "📝 <strong>Meta Description</strong> - opis strony w wynikach Google. Max 160 znaków, zachęca do kliknięcia.",
    "canonical": "🔗 <strong>Canonical URL</strong> - znacznik wskazujący główną wersję strony. Zapobiega duplikatom.",
    "sitemap": "🗺️ <strong>Sitemap</strong> - mapa strony XML ułatwiająca robotom Google indeksowanie treści.",
    "robots.txt": "🤖 <strong>Robots.txt</strong> - plik instruujący roboty wyszukiwarek co mogą indeksować.",
    "alt text": "🖼️ <strong>Alt Text</strong> - tekst alternatywny obrazu dla SEO i dostępności.",
    "anchor text": "⚓ <strong>Anchor Text</strong> - klikalny tekst linku. Ważny dla SEO wewnętrznego i zewnętrznego.",
    "backlink": "🔙 <strong>Backlink</strong> - link do Twojej strony z innej witryny. Buduje autorytet w Google.",
    "keyword": "🔑 <strong>Keyword</strong> - słowo kluczowe, fraza którą użytkownicy wpisują w Google.",
    "long tail keyword": "🦎 <strong>Long Tail Keyword</strong> - długa, szczegółowa fraza (np. 'tani fryzjer Wrocław Krzyki').",
    "rich snippet": "⭐ <strong>Rich Snippet</strong> - rozszerzony wynik w Google z gwiazdkami, ceną, dostępnością.",
    "schema markup": "🏷️ <strong>Schema Markup</strong> - kod strukturalny pomagający Google zrozumieć treść strony.",
    "google search console": "🔍 <strong>Google Search Console</strong> - darmowe narzędzie Google do monitorowania widoczności strony.",
    "google analytics": "📈 <strong>Google Analytics</strong> - narzędzie do analizy ruchu na stronie. Kto, skąd, co robi.",

    // --- NOWE: BEZPIECZEŃSTWO ZAAWANSOWANE ---
    "phishing": "🎣 <strong>Phishing</strong> - atak polegający na podszywaniu się pod zaufaną stronę/osobę.",
    "xss": "💉 <strong>XSS</strong> - atak wstrzykujący złośliwy kod JavaScript na stronę.",
    "sql injection": "�� <strong>SQL Injection</strong> - atak wstrzykujący kod SQL do bazy danych przez formularz.",
    "brute force": "🔨 <strong>Brute Force</strong> - atak próbujący odgadnąć hasło przez masowe próby.",
    "2fa": "🔐 <strong>2FA</strong> - dwuskładnikowe uwierzytelnianie. Hasło + kod z telefonu.",
    "captcha": "🤖 <strong>CAPTCHA</strong> - test odróżniający ludzi od botów. Chroni formularze przed spamem.",
    "recaptcha": "✅ <strong>reCAPTCHA</strong> - system Google weryfikujący czy użytkownik jest człowiekiem.",
    ...
    "upselling": "⬆️ <strong>Upselling</strong> - oferowanie droższej wersji produktu (np. większy rozmiar).",
    "cross-selling": "↔️ <strong>Cross-selling</strong> - oferowanie produktów powiązanych (np. etui do telefonu).",
    "abandoned cart": "🛒 <strong>Abandoned Cart</strong> - porzucony koszyk. Email przypominający może odzyskać sprzedaż.",
    "conversion rate": "📊 <strong>Conversion Rate</strong> - współczynnik konwersji. Procent odwiedzających dokonujących zakupu.",
    "payment gateway": "💳 <strong>Payment Gateway</strong> - bramka płatności łącząca sklep z bankiem/operatorem.",
    "inventory": "📦 <strong>Inventory</strong> - stan magazynowy produktów w sklepie.",
    ...
    "funnel": "🔻 <strong>Funnel</strong> - lejek sprzedażowy. Ścieżka klienta od pierwszego kontaktu do zakupu.",
    "lead": "👤 <strong>Lead</strong> - potencjalny klient który zostawił kontakt (np. przez formularz).",
    "lead magnet": "🧲 <strong>Lead Magnet</strong> - gratka (ebook, rabat) w zamian za email. Buduje bazę kontaktów.",
    "a/b testing": "🔬 <strong>A/B Testing</strong> - test dwóch wersji strony/elementu. Wygrywa skuteczniejsza.",
    "heatmap": "🔥 <strong>Heatmap</strong> - mapa ciepła pokazująca gdzie użytkownicy klikają i scrollują.",
    "retargeting": "🎯 <strong>Retargeting</strong> - reklamy śledzące użytkowników którzy odwiedzili Twoją stronę.",

    // --- NOWE: HOSTING & INFRASTRUKTURA ---
    "vps": "🖥️ <strong>VPS</strong> - Virtual Private Server. Wirtualny serwer z dedykowanymi zasobami.",
    "dedicated server": "🏢 <strong>Dedicated Server</strong> - fizyczny serwer tylko dla Ciebie. Maksymalna wydajność.",
    "shared hosting": "👥 <strong>Shared Hosting</strong> - hosting współdzielony. Tani, ale zasoby dzielone z innymi.",
    "cloud hosting": "☁️ <strong>Cloud Hosting</strong> - hosting w chmurze. Skalowalny, płacisz za użycie.",
    "uptime": "⏰ <strong>Uptime</strong> - czas dostępności serwera. 99.9% = max ~8h niedostępności rocznie.",
    "bandwidth": "📶 <strong>Bandwidth</strong> - przepustowość transferu danych. Ile GB miesięcznie możesz przesłać.",
    "cpanel": "🎛️ <strong>cPanel</strong> - panel do zarządzania hostingiem. Pliki, bazy, email, domeny.",
    "phpmyadmin": "🗄️ <strong>phpMyAdmin</strong> - narzędzie do zarządzania bazą MySQL przez przeglądarkę.",
    ...
    "polityka prywatności": "📜 <strong>Polityka Prywatności</strong> - dokument opisujący jak strona zbiera i przetwarza dane.",
    "cookies": "🍪 <strong>Cookies</strong> - małe pliki zapisywane w przeglądarce. Wymagają zgody użytkownika.",
    "regulamin": "📑 <strong>Regulamin</strong> - zasady korzystania ze strony/sklepu. Obowiązkowy dla e-commerce.",
    "nip": "🏛️ <strong>NIP</strong> - Numer Identyfikacji Podatkowej. Wymagany na fakturach i stronie firmy.",
    "ssl certificate": "🔒 <strong>Certyfikat SSL</strong> - potwierdza tożsamość strony i szyfruje dane. Zielona kłódka.",

    // --- NOWE: RÓŻNE PRZYDATNE ---
    "mvp": "🚀 <strong>MVP</strong> - Minimum Viable Product. Najprostsza wersja produktu do szybkiego startu.",
    "agile": "🔄 <strong>Agile</strong> - metodyka pracy w krótkich cyklach (sprintach). Elastyczna i iteracyjna.",
    "scrum": "📊 <strong>Scrum</strong> - framework Agile z rolami (Product Owner, Scrum Master) i ceremoniami.",
    "deploy": "🚀 <strong>Deploy</strong> - wdrożenie, publikacja strony na serwerze produkcyjnym.",
    "staging": "🧪 <strong>Staging</strong> - środowisko testowe. Kopia strony do testów przed publikacją.",
    "localhost": "🏠 <strong>Localhost</strong> - lokalny serwer na Twoim komputerze do developmentu.",
    "debug": "🐛 <strong>Debug</strong> - szukanie i naprawianie błędów w kodzie.",
    "framework": "🏗️ <strong>Framework</strong> - gotowy szkielet do budowania aplikacji. Przyspiesza development.",
    "cms headless": "🤯 <strong>Headless CMS</strong> - CMS bez frontendu. Dostarcza treści przez API do dowolnego interfejsu.",
    "jamstack": "⚡ <strong>JAMstack</strong> - architektura stron: JavaScript, API, Markup. Superszybkie i bezpieczne.",
  ...
  const definitionPatterns = [
    "co to jest", "co to", "czym jest", "co znaczy", "co oznacza",
    "definicja", "wyjaśnij", "wytłumacz", "powiedz mi co to",
    "nie wiem co to", "nie rozumiem co to", "co masz na myśli"
  ];
  ...
  function checkGlossary(message) {
    ...
    const isDefinitionQuestion = definitionPatterns.some(pattern => lowerMessage.includes(pattern));
