// functions/templates/briefConfirmationEmail.js
// Brief submission confirmation email template (sent to client after submit)
// DominDev brand colors: #ff1f1f, #cc0000, #050505, #0f0f0f

import { escapeHtml } from "./helpers.js";

/**
 * Generate HTML for brief confirmation email (sent to client)
 * @param {Object} params
 * @param {string} params.name - Client name
 * @returns {string} - Complete HTML email
 */
export function generateBriefConfirmationEmailHTML({ name }) {
  const greeting = name ? `Dziękuję, <span style="color: #ff1f1f;">${escapeHtml(name)}</span>` : `Dziękuję`;
        ...
        <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="background-color: #0f0f0f; border: 1px solid #262626; max-width: 600px; width: 100%;">
          ...
          <tr>
            <td style="padding: 40px 40px 30px; border-bottom: 1px solid #262626; text-align: center;">
              ...
              <p class="font-body" style="margin: 0; color: #ff1f1f; font-family: 'Courier New', monospace; font-size: 11px; letter-spacing: 2px; text-transform: uppercase;">● Brief Przyjęty</p>
          ...
          <tr>
            <td style="padding: 40px;">
              <p class="font-body" style="margin: 0 0 25px 0; color: #c0c0c0; font-family: 'Courier New', monospace; font-size: 15px; line-height: 1.7;">
                Twój brief projektowy został pomyślnie przesłany. Analizuję odpowiedzi i przygotuję wstępną propozycję.
              </p>
              ...
              <div style="margin: 30px 0; padding: 25px; background-color: #0a0a0a; border-left: 3px solid #ff1f1f;">
                <p class="font-body" style="margin: 0; color: #ffffff; font-family: 'Courier New', monospace; font-size: 13px;">
                  <strong style="color: #ff1f1f; text-transform: uppercase; letter-spacing: 1px;">Co dalej?</strong><br><br>
                  Na podstawie Twojego briefu przygotuję wstępną wizję projektu — propozycję stylu, struktury i zakresu. Otrzymasz ją mailem.
                </p>
              </div>
