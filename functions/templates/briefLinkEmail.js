// functions/templates/briefLinkEmail.js
// Brief link autoresponder email template (sent to WebDev clients)
// DominDev brand colors: #ff1f1f, #cc0000, #050505, #0f0f0f

import { escapeHtml } from "./helpers.js";

/**
 * Generate HTML for brief link autoresponder email
 * @param {Object} params - Email parameters
 * @param {string} params.name - Recipient's name
 * @param {string} params.briefLink - Signed brief URL
 * @returns {string} - Complete HTML email
 */
export function generateBriefLinkEmailHTML({ name, briefLink }) {
  return `
<!DOCTYPE html>
<html lang="pl">
<head>
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <div style="margin: 30px 0; padding: 25px; background-color: #0a0a0a; border-left: 3px solid #ff1f1f;">
                <p class="font-body" style="margin: 0 0 10px 0; color: #ffffff; font-family: 'Courier New', monospace; font-size: 13px;">
                  <strong style="color: #ff1f1f; text-transform: uppercase; letter-spacing: 1px;">Następny krok:</strong>
                </p>
                <p class="font-body" style="margin: 0 0 20px 0; color: #c0c0c0; font-family: 'Courier New', monospace; font-size: 14px; line-height: 1.6;">
                  Wypełnij krótki brief projektowy — pomoże mi precyzyjnie określić zakres i wycenę Twojego projektu.
                </p>
                <table role="presentation" cellspacing="0" cellpadding="0">
                  <tr>
                    <td>
                      <a href="${escapeHtml(briefLink)}" class="font-display" style="display: inline-block; padding: 14px 28px; background-color: #ff1f1f; color: #000000; text-decoration: none; font-family: Arial, sans-serif; font-size: 13px; font-weight: 900; letter-spacing: 1px; text-transform: uppercase; border: none;">Wypełnij Brief Projektowy</a>
                    </td>
                  </tr>
                </table>
                <p class="font-body" style="margin: 15px 0 0 0; color: #666666; font-family: 'Courier New', monospace; font-size: 11px;">
                  Link ważny przez 7 dni. Jednorazowego użytku.
                </p>
              </div>

              <div style="margin: 30px 0; padding: 25px; background-color: #0a0a0a; border-left: 3px solid #333333;">
